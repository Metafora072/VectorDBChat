...
// P07 A0 experiment hook: associates the calling thread's next search with a
// stable query id. It is inert unless P07_TRACE_PATH is set.
DISKANN_DLLEXPORT void p07_set_trace_query_id(uint64_t query_id);
