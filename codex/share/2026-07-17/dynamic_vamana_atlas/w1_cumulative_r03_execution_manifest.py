#!/usr/bin/env python3
"""Create or transition the fail-closed CP05 cumulative R03 execution manifest."""
...
def main() -> None:
    ...
    if args.action == "activate":
        ...
        if args.manifest.exists() or any(path is None or not path.is_file() for path in required):
            raise SystemExit("R03 activation requires fresh manifest and all frozen gate evidence")
        ...
        payload: dict[str, object] = {
            "schema": "dynamic-vamana-w1-cp05-cumulative-r03-execution-v1",
            "status": "running",
            ...
            "formal_root": str(atlas_root / "formal/pilot3_sift10m_w1_cp05_trajectory_r03"),
            "replay_run": "pilot3_w1_cp05_trajectory_replay_r03",
            "replay_formal_root": str(atlas_root / "formal/pilot3_w1_cp05_trajectory_replay_r03"),
            ...
            "terminal_r02_manifest_realpath": str(args.old_attempt_manifest.resolve()),
            "terminal_r02_manifest_sha256": sha256(args.old_attempt_manifest),
            "authorized_sequence": ["CP00", "CP01", "CP05"],
            "attempts": {
                "DGAI_replay": "sequential-cp80-03",
                "OdinANN_replay": "sequential-cp80-03",
                "DGAI_formal": "trajectory-cp05-03",
                "OdinANN_formal": "trajectory-cp05-03",
                "DiskANN": "stale-cp05-03",
            },
