#!/usr/bin/env python3
"""Create or transition the fail-closed CP05 cumulative R08 execution manifest."""
...
def main() -> None:
    ...
    if args.action == "activate":
        ...
        if args.manifest.exists() or any(path is None or not path.is_file() for path in required):
            raise SystemExit("R08 activation requires fresh manifest and all frozen gate evidence")
        ...
        payload: dict[str, object] = {
            "schema": "dynamic-vamana-w1-cp05-cumulative-r08-execution-v1",
            "status": "running",
            ...
            "formal_root": str(atlas_root / "formal/pilot3_sift10m_w1_cp05_trajectory_r08"),
            "replay_run": "pilot3_w1_cp05_trajectory_replay_r08",
            "replay_formal_root": str(atlas_root / "formal/pilot3_w1_cp05_trajectory_replay_r08"),
            ...
            "attempts": {
                "DGAI_replay": "sequential-cp80-08",
                "OdinANN_replay": "sequential-cp80-08",
                "DGAI_formal": "trajectory-cp05-08",
                "OdinANN_formal": "trajectory-cp05-08",
                "DiskANN": "stale-cp05-08",
            },
